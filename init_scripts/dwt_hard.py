...
original_song = MidiFile("random1.mid")
test_song = MidiFile("RetentionPhraseA.mid")
test = dtwLists(midiToArrayVer1(original_song), midiToArrayVer2(test_song), dist=dtw)
print(test)
#test for chords
#custom_distance = lambda x, y: 0 if x==y else 1
#d = dtw([1,2,4],[1,2],dist=custom_distance)
#print(d)
#
...
#test for songs
#test = dtwLists([[1],[2],[3],[4,1,2]], [[1],[3],[3],[4],[1,2]], dist=dtw)
