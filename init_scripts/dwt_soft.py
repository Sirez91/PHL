...
#main
orig_song = MidiFile("original_song.mid")
test_song = MidiFile("test_song.mid")
d, cost_matrix, acc_cost_matrix, path = dtwLists(midiToArray(orig_song), midiToArray(test_song), dist=dtw)
#d, cost_matrix, acc_cost_matrix, path = dtwLists([[1],[2],[3],[4,1,2]], [[1],[4],[3],[4],[5,1,2]], dist=dtw)
print(d)
print(cost_matrix)
